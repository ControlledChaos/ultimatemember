    ...
    class Fields {
        ...
        function add_field_from_list( $global_id, $form_id, $position = array() ) {
            ...
            if (!isset( $fields[$global_id] )) {
                ...
                for( $i = 1; $i < 5; $i++ ){
                    unset($fields[$last_key]['conditional_action'.$i]);
                    unset($fields[$last_key]['conditional_field'.$i]);
                    unset($fields[$last_key]['conditional_operator'.$i]);
                    unset($fields[$last_key]['conditional_value'.$i]);
                    unset($fields[$last_key]['conditional_group'.$i]);
                    unset($fields[$last_key]['conditional_compare'.$i]);
                }
